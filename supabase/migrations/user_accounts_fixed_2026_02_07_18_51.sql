-- Check existing table structure and create comprehensive user accounts
-- First, let's see what tables exist and their structure

-- Drop and recreate user_permissions table with correct structure
...
-- Clear existing data and insert comprehensive user accounts
...
-- Show summary
SELECT 
    'SUCCESS: Comprehensive user accounts created!' as status,
